...
int test3() {
  ...
  struct Person *sorted_people =
      sorted(people, (sizeof people) / sizeof(struct Person),
             sizeof(struct Person), &person_cmp);
  int passed = !(strcmp(sorted_people[0].name, "Sneed") +
